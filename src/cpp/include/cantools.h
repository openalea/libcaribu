...
// passage des valeurs Normalis�es vers un octet CHAR
#define N2CHAR 255
...
void Get_Image(char * ImageBuffer, 
		int iViewWidth, 
	       int iViewHeight) ;
/* Copie le buffer pcImageBuffer, aiment� par bvis, dans ImageBuffer,
...
/* renvoie une structure permettant l'identificaton compl�te
 * de la primitive */
...
/* cr�e un index univoque avec le label de la primitive passe dans
 * une structure Prim *
 * appelle Decode_Data */

int Label_2_Indexf (double donnee ) ;
/* cr�e un index univoque avec le label de la primitive passe au format
 * double
